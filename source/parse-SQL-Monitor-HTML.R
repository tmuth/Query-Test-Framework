...
sqlMonResults_DF.melt <- melt(sqlMonResults_DF, id.var = c("parallel_degree"), measure.var = c("dbTimePctCPU", "dbTimePctIO","dbTimePctOther", "dbTimePctCluster","dbTimePctApp","dbTimePctQueuing"))
...
ggplot(data=sqlMonResults_DF.melt)+
  geom_bar(width=1.8,aes(x=parallel_degree,y=value,fill=variable),stat='identity',position='stack')+
